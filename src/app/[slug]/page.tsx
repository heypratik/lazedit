  ...
  if (!(slug in pageDetails)) {
    ...
    return (
        <>
                ...
                <meta property="og:description" content="AI Image Editor Tool | Edit images by just telling LazeEdit what you want. Remove backgrounds, change text, create banners - no design skills needed. Free Photoshop alternative with AI magic." />
                ...
                <meta name="twitter:description" content="AI Image Editor Tool | Edit images by just telling LazeEdit what you want. Remove backgrounds, change text, create banners - no design skills needed. Free Photoshop alternative with AI magic." />
                ...
                <Header />
                <Hero title={pageData['hero'].title} description={pageData['hero'].description} subdescription={pageData['hero'].subdescription}  />
                <Features />
                <Reviews />
                <Pricing />
                <FAQ />
