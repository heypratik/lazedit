...
const TemplateModal = ({ handleProductSelect }) => {
  return (
          ...
          <div className="search mb-5">
            ...
            >
              <li onClick={() => handleProductSelect("product-1")}>
                <Image
                  src="/Screenshot 2024-07-22 171344 1.png"
                  alt="Vercel Logo"
              ...
              <li onClick={() => handleProductSelect("product-4")}>
                <Image
                  src="/Screenshot 2024-07-22 171119 1.png"
                  alt="Vercel Logo"
                  className="dark:invert"
                  width={180}
                  height={180}
              ...
              <li onClick={() => handleProductSelect("product-5")}>
                <Image
                  src="/Screenshot 2024-07-22 171406 1.png"
                  alt="Vercel Logo"
                  className="dark:invert"
                  width={180}
                  height={180}
              ...
              <li onClick={() => handleProductSelect("product-8")}>
                <Image
                  src="/Screenshot 2024-07-22 172427 1.png"
                  alt="Vercel Logo"
                  className="dark:invert"
                  width={180}
                  height={180}
